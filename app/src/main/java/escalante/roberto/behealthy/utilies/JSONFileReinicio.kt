...
class JSONFileReinicio{

    val reinicio = "data5.json"
    ...
    fun saveData(context: Context, json:String){
        ...
        try {
            ...
            context.openFileOutput(reinicio, Context.MODE_PRIVATE).use {
    ...
    fun getData(context: Context): String{
        ...
        try {
            return context.openFileInput(reinicio).bufferedReader().readLine()
        }
        catch (e: IOException){
